 ...
 * ====================================================================== */    
     ...
     * ====================================================================== */
        ...
        var settings                    = $jq.extend(true, {}, DatepickerInFullscreen.DEFAULTS, options);

        /* VARS */
        
        var $input                      = $jq(input); 
        var input_placeholder           = $input.attr('placeholder') == undefined ? '' : $input.attr('placeholder');
        var $fake_input                 = $jq('<div class="dpifs-fake-input"></div>');
     ...
     * ====================================================================== */    
        ...
        $input.on('click', function(){
            ...
            $jq('.datepicker-in-fullscreen-modal, .datepicker-in-fullscreen-background').remove();
 ...
 * ====================================================================== */
    ...
    $jq.fn.datepickerInFullscreen = function(options, content, callback) {
